...
TEST_CASE("BigNum encoding", "BigNum Encode") {
	...
	REQUIRE(neg_num.bitStr() == "00010010 00110100 00010000");

	BigNum odd_size("12345");
	std::cout << odd_size.bitStr() << std::endl;
	REQUIRE(odd_size.bitStr() == "00010010 00110100 01010000 00000001");

	BigNum odd_size_neg("12345", true);
	REQUIRE(odd_size_neg.bitStr() == "00010010 00110100 01010000 00010001");
